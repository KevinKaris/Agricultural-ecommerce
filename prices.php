...
<body>
    <style>
        ...
        #price .note {
            padding: 1vw;
            background: rgba(255, 255, 183, 0.401);
            border-left: 5px ridge rgb(230, 230, 18);
            color: #484848;
    ...
    <?php include 'DB-config/db-config.php';
...
<?php
include_once 'includes/guest-footer.html';
?>
