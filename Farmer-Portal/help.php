...
<body>
    ...
    <div id="content">
        ...
        <div class="row m-3" id="price">
            ...
            Below is video showing how to post a product. For more help contact us...
        </div>
            <div class="video-part" align="center">
                <video id="video1" src="../images/posting product_Trim.mp4" controls poster="../images/posting product.jpg"></video>
