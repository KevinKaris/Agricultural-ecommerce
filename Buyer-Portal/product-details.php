...
<body>
        ...
        <div class="container product-details bg-light p-2 row">
            ...
            <div class="col-md-4 column details" align="center">
                ...
                <?php if (!empty($details['stock_available'])) {
                    echo "<p class='w-100'><?php echo 'Stock available. ' . $details[stock_available]; ?></p>";
                } ?>
                <?php if (!empty($details['stock_expiry'])) {
                    echo "<p class='w-100'><?php echo 'Product expiry. ' . $details[stock_expiry]; ?></p>";
                } ?>
                <p class='w-100'>
                            ...
                            <a onclick="javascript:this.parentNode.submit();">
                                ...
                                <div class="card-title mt-4">
                                    ...
                                    <?php if (!empty($row['stock_available'])) {
                                        echo "<p class='w-100 m-0 p-0'><?php echo 'Stock available. ' . $row[stock_available]; ?></p>";
                                    } ?>
    ...
    $statement->bind_param('ssss', $data['email'], $details['product_title'], $details['product_category'], $details['specific_location']);
    $statement->execute();
    ?>
