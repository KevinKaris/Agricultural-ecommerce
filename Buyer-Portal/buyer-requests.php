...
<body>
    ...
    <div id="content">
        ...
        <?php
        $sql = "SELECT * FROM buyer_request WHERE buyer_id = $id";
        $execute_buyer_request = mysqli_query($connection, $sql);
        $num_of_rows = mysqli_num_rows($execute_buyer_request); ?>
        <div id="table-container">
                 <table>
                    ...
                    <?php
                    if ($num_of_rows == 0) {
                        $message2 = "<h4 style='padding-bottom: 30%;'>You have not yet uploaded any request!</h4>";
                    } else {
                        while ($row_details = mysqli_fetch_assoc($execute_buyer_request)) { ?>
                        <tr>
                            <td>
                            <?php
                            ...
                            <td><?php echo $row_details['request_id']; ?></td>
                            <td><?php echo $row_details['stock_needed']; ?></td>
                            ...
                            <div class="buttons" align="center">
                                        <form action="edit" method="get">
                                            <input type="hidden" name="edit-id"
                                                value="<?php echo $row_details['request_id']; ?>">
                                            <button class="btn btn-sm btn-info rounded-circle" type="submit"
                                                name="edit-button"><i class="fas fa-pen"></i></button>
                                        </form>
                                        <form action="../server/delete-buyer-request.php" method="post">
                                            <input type="hidden" name="edit-id"
                                                value="<?php echo $row_details['request_id']; ?>">
                                            <button class="btn btn-sm btn-danger delete-button rounded-circle" type="submit"
